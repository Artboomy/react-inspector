...
export interface ObjectInspectorProps
  ...
  /** Function called after search. True means inspector has results and rendered, false - no results and no render */
  searchCallback?: (hasResults: boolean) => void;
}
...
export const partialHighlight: (
  value: any,
  highlight: string,
  options: { style: any; caseInsensitive?: boolean }
) => React.ReactNode;

export const fullHighlight: (
  value: any,
  highlight: string,
  options: { style?: any; caseInsensitive?: boolean }
) => React.ReactNode;
